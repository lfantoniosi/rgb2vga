...
create_generated_clock -name {inst6|altpll_component|auto_generated|pll1|clk[0]} -source [get_pins {inst6|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50.000 -multiply_by 126 -divide_by 55 -phase 180.000 -master_clock {CLOCK_50} [get_pins {inst6|altpll_component|auto_generated|pll1|clk[0]}] 
create_generated_clock -name {inst6|altpll_component|auto_generated|pll1|clk[1]} -source [get_pins {inst6|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50.000 -multiply_by 63 -divide_by 125 -phase 180.000 -master_clock {CLOCK_50} [get_pins {inst6|altpll_component|auto_generated|pll1|clk[1]}] 
